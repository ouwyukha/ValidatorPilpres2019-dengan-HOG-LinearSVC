...
for feature in images:
    fd = hog(feature, orientations=9, pixels_per_cell=(2, 2), cells_per_block=(16, 16), visualize=False)
...
# Save the classifier
joblib.dump(clf, "LinearSVC_HOG2-16_CLF.pkl", compress=3)

os.system("LinearSVC_HOG2-16_BALANCED_predict.py")