...
for feature in images:
    fd = hog(feature, orientations=9, pixels_per_cell=(4, 4), cells_per_block=(8, 8), visualize=False)
...
# Save the classifier
joblib.dump(clf, "LinearSVC_HOG4-8_CLF.pkl", compress=3)

os.system("LinearSVC_HOG4-8_BALANCED_predict.py")