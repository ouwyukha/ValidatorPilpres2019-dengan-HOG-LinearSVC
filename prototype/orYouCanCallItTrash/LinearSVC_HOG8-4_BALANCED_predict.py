...
clf = joblib.load("LinearSVC_HOG8-4_CLF.pkl")

#clf = joblib.load("hogBalanced_ppc8_cpb4.pkl")
...
for img_path,real in zip(test_images_path,name):
    ...
    roi_hog_fd = hog(image, orientations=9, pixels_per_cell=(8, 8), cells_per_block=(4, 4), visualize=False)
...
print("8_4 - Score : "+str(score)+" of "+str(maxscore)+"\nAccuracy : "+str(score/maxscore))

os.system("LinearSVC_HOG12-3_BALANCED.py")