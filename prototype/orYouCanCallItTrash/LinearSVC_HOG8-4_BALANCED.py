...
for feature in images:
    fd = hog(feature, orientations=9, pixels_per_cell=(8, 8), cells_per_block=(4, 4), visualize=False)
...
# Save the classifier
joblib.dump(clf, "LinearSVC_HOG8-4_CLF.pkl", compress=3)

os.system("LinearSVC_HOG8-4_BALANCED_predict.py")