...
clf = joblib.load("LinearSVC_HOG2-8_CLF.pkl")

#clf = joblib.load("hogBalanced_ppc2_cpb8.pkl")
...
for img_path,real in zip(test_images_path,name):
    ...
    roi_hog_fd = hog(image, orientations=9, pixels_per_cell=(2,2), cells_per_block=(8,8), visualize=False)
...
print("2_8 - Score : "+str(score)+" of "+str(maxscore)+"\nAccuracy : "+str(score/maxscore))